...
?>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-3 display-none">
                            <div class="menu-right">
                                <ul>
                                    <li><a class="search-trigger" href="javascript:void(0)"><i><img
                                                        src="<?php echo get_template_directory_uri(); ?>/images/search.svg"></i></a>
                                    </li>
    ...
    <div class="search-popup">
        <div class="close-button">
            <button class="close-trigger"><i class="fas fa-times"></i></button>
        </div>
        <div class="inner">
    ...
    <!-- End Search Popup  -->
<?php get_template_part('template-parts/breadcrumb/breadcrumb', 'v1') ?>